...
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, true);
 ...
 "Accept-Language:id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7");
    $response = $this->curls('http://indosatooredoo.com/api/v1/login/request-otp',$header,$body,'POST');
    return $response;
  }
  ...
  function login($msisdn,$otp)
  {
    ...
    $ctl = strlen($body);
    $header = array("Host:indosatooredoo.com" ,
 "Connection:keep-alive" ,
 "Content-Length:" . $ctl ,
 "Accept:application/json, text/plain, */*" ,
 "Origin:http://indosatooredoo.com" ,
 "Authorization:Basic Ym9uc3RyaTpib25zdHJpc2VjcmV0" ,
 "User-Agent:Mozilla/5.0 (Linux; Android 9; Redmi Note 7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.99 Mobile Safari/537.36" ,
 "Content-Type:application/x-www-form-urlencoded" ,
 "Referer:http://indosatooredoo.com/login?returnUrl=%2Fhome" ,
 "Accept-Encoding:gzip, deflate" ,
 "Accept-Language:id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7");
    $response = $this->curls('http://indosatooredoo.com/api/v1/login/validate-otp',$header,$body,'POST');
    return $response[1];
  }
 ...
 "User-Agent:Mozilla/5.0 (Linux; Android 9; Redmi Note 7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.99 Mobile Safari/537.36" ,
 "Content-Type:application/json" ,
 "Referer:http://indosatooredoo.com/voucherku" ,
 "Accept-Encoding:gzip, deflate" ,
 "Accept-Language:id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7");
   $response = $this->curls("http://indosatooredoo.com/api/v1/voucherku/voucher-history",$header,$body,"POST");
   return $response[1];
 ...
 "Accept-Encoding:gzip, deflate" ,
 "Accept-Language:id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7");
     $response = $this->curls("http://indosatooredoo.com/api/v1/voucherku/get-voucher-code",$header,$body,"POST");
     return $response[1];
  }
